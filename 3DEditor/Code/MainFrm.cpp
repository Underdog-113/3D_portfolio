...
BOOL CMainFrame::OnCreateClient(LPCREATESTRUCT lpcs, CCreateContext* pContext)
{
	...
	*/
	...
	m_mainSplitter.CreateView(0, 0, RUNTIME_CLASS(CMy3DEditorView), CSize(VIEWCX, VIEWCY), pContext);
	m_mainSplitter.CreateView(0, 1, RUNTIME_CLASS(CInspectorView), CSize(VIEWCX, VIEWCY), pContext);
