...
void CEffectMaker_Theresa::CreateEffect_Attack1_1()
{
	...
	auto effect = CreateEffect_Trail(AttackTrail_ObjectKey, L"Theresa_Att_1", AttackTrail_Tex1Name, AttackTrail_Tex2Name);
...
void CEffectMaker_Theresa::CreateEffect_Attack1_2()
{
	...
	auto effect = CreateEffect_Trail(AttackTrail_ObjectKey, L"Theresa_Att_1_2", AttackTrail_Tex1Name, AttackTrail_Tex2Name);
	effect->GetTransform()->SetPosition(m_pTheresa->GetTransform()->GetPosition());
...
void CEffectMaker_Theresa::CreateEffect_Attack2_1()
{
	...
	auto effect = CreateEffect_Trail(AttackTrail_ObjectKey, L"Theresa_Att_2", AttackTrail_Tex1Name, AttackTrail_Tex2Name);
	effect->GetTransform()->SetPosition(m_pTheresa->GetTransform()->GetPosition());
	effect->GetTransform()->AddPositionY(m_pTheresa->GetComponent<Engine::CMeshC>()->GetHalfYOffset());
	effect->GetTransform()->SetSize(_float3(size, size, size));
...
void CEffectMaker_Theresa::CreateEffect_Attack2_2()
{
	...
	auto effect = CreateEffect_Trail(AttackTrail_ObjectKey, L"Theresa_Att_2_2", AttackTrail_Tex1Name, AttackTrail_Tex2Name);
	effect->GetTransform()->SetPosition(m_pTheresa->GetTransform()->GetPosition());
	effect->GetTransform()->AddPositionY(m_pTheresa->GetComponent<Engine::CMeshC>()->GetHalfYOffset());
	effect->GetTransform()->SetSize(_float3(size, size, size));
...
void CEffectMaker_Theresa::CreateEffect_Attack3_1()
{
	...
	auto effect = CreateEffect_Trail(AttackTrail_ObjectKey, L"Theresa_Att_3", AttackTrail_Tex1Name, AttackTrail_Tex2Name);
	effect->GetTransform()->SetPosition(m_pTheresa->GetTransform()->GetPosition());
	effect->GetTransform()->AddPositionY(m_pTheresa->GetComponent<Engine::CMeshC>()->GetHalfYOffset());
	effect->GetTransform()->SetSize(_float3(size, size, size));
...
void CEffectMaker_Theresa::CreateEffect_Attack3_2()
{
	...
	auto effect = CreateEffect_Trail(AttackTrail_ObjectKey, L"Theresa_Att_3_2", AttackTrail_Tex1Name, AttackTrail_Tex2Name);
	effect->GetTransform()->SetPosition(m_pTheresa->GetTransform()->GetPosition());
	effect->GetTransform()->AddPositionY(m_pTheresa->GetComponent<Engine::CMeshC>()->GetHalfYOffset());
	effect->GetTransform()->SetSize(_float3(size, size, size));
...
void CEffectMaker_Theresa::CreateEffect_Attack4_1()
{
	...
	auto effect = CreateEffect_Trail(AttackTrail_ObjectKey, L"Theresa_Att_4", AttackTrail_Tex1Name, AttackTrail_Tex2Name);
	effect->GetTransform()->SetPosition(m_pTheresa->GetTransform()->GetPosition());
	effect->GetTransform()->AddPositionY(m_pTheresa->GetComponent<Engine::CMeshC>()->GetHalfYOffset());
	effect->GetTransform()->SetSize(_float3(size, size, size));
...
void CEffectMaker_Theresa::CreateEffect_Attack4_2()
{
	...
	auto effect = CreateEffect_Trail(AttackTrail_ObjectKey, L"Theresa_Att_4_2", AttackTrail_Tex1Name, AttackTrail_Tex2Name);
	effect->GetTransform()->SetPosition(m_pTheresa->GetTransform()->GetPosition());
	effect->GetTransform()->AddPositionY(m_pTheresa->GetComponent<Engine::CMeshC>()->GetHalfYOffset());
	effect->GetTransform()->SetSize(_float3(size, size, size));
