...
void CKiana_CatPaw_Atk02::OnCollisionEnter(Engine::_CollisionInfo ci)
{
...
void CKiana_CatPaw_Atk02::OnCollisionExit(Engine::_CollisionInfo ci)
{
}
...
void CKiana_CatPaw_Atk02::SetupPaw(CObject * pOwner, HitInfo info)
{
	m_pKiana = pOwner;
	m_hitInfo = info;
}
