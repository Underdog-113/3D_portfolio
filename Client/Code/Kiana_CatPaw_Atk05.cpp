...
void CKiana_CatPaw_Atk05::OnCollisionExit(Engine::_CollisionInfo ci)
{
}

void CKiana_CatPaw_Atk05::OnTriggerEnter(Engine::CCollisionC const * pCollisionC)
{
...
void CKiana_CatPaw_Atk05::OnTriggerStay(Engine::CCollisionC const * pCollisionC)
{
}

void CKiana_CatPaw_Atk05::OnTriggerExit(Engine::CCollisionC const * pCollisionC)
{
}
...
void CKiana_CatPaw_Atk05::FindMidBone(void)
{
...
void CKiana_CatPaw_Atk05::SetupPaw(CObject * pOwner, HitInfo info)
{
	m_pOwner = pOwner;
	m_hitInfo = info;
}
