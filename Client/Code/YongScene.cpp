...
void CYongScene::Update(void)
{
	...
	{
		SP(Engine::CObject) spObj = GetObjectFactory()->AddClone(L"Bronya_Teleport_Ring", true, (_uint)Engine::ELayerID::Effect);
			...
			//		spObj->GetTransform()->SetPosition(_float3(/* ���γ��� ��ġ + */ _float(rand() % 3 - 0.2f), /* ���γ��� ��ġ + */ _float(rand() % 2) - 0.3f,/* ���γ��� ��ġ + */ _float(rand() % 3)));
			//		spObj->GetComponent<Engine::CTextureC>()->AddTexture(L"Fx_Fire_01");
			//		spObj->GetComponent<Engine::CTextureC>()->AddTexture(L"Fx_Fire_01");
			//		break;
			//	case 1:
			//		spObj = Engine::GET_CUR_SCENE->GetObjectFactory()->AddClone(L"Bronya_RandomSmoke", true);
			//		spObj->GetTransform()->SetPosition(_float3(/* ���γ��� ��ġ + */ _float(rand() % 3 - 0.2f), /* ���γ��� ��ġ + */_float(rand() % 2) - 0.7f, /* ���γ��� ��ġ + */_float(rand() % 3)));
			//		spObj->GetComponent<Engine::CTextureC>()->AddTexture(L"fx_snowfield_fog03");
			//		spObj->GetComponent<Engine::CTextureC>()->AddTexture(L"fx_snowfield_fog03");
			//		break;
			//	case 2:
			//		spObj = Engine::GET_CUR_SCENE->GetObjectFactory()->AddClone(L"Bronya_RandomSmoke", true);
			//		spObj->GetTransform()->SetPosition(_float3(/* ���γ��� ��ġ + */ _float(rand() % 3 - 0.2f),/* ���γ��� ��ġ + */ _float(rand() % 2) - 0.2f,/* ���γ��� ��ġ + */ _float(rand() % 3)));
			//		spObj->GetComponent<Engine::CTextureC>()->AddTexture(L"fx_snowfield_fog03");
			//		spObj->GetComponent<Engine::CTextureC>()->AddTexture(L"fx_snowfield_fog03");
			//		break;
			//	case 3:
