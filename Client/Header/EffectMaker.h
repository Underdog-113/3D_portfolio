...
public:
	SP(Engine::CObject) CreateEffect_Trail(std::wstring objectKey, std::wstring name, std::wstring texName1, std::wstring texName2, std::wstring objName = L"Valkyrie_Effect");
