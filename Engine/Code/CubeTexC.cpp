...
void CCubeTexC::InitIndexBuffer(void)
{
	...
	// X+
	pIndices[0]._0 = 1;	pIndices[1]._0 = 1;
	pIndices[0]._1 = 5;	pIndices[1]._1 = 6;
	pIndices[0]._2 = 6;	pIndices[1]._2 = 2;

	// X-
	pIndices[2]._0 = 4;	pIndices[3]._0 = 4;
	pIndices[2]._1 = 0;	pIndices[3]._1 = 3;
	pIndices[2]._2 = 3;	pIndices[3]._2 = 7;

	// y+
	pIndices[4]._0 = 4;	pIndices[5]._0 = 4;
	pIndices[4]._1 = 5;	pIndices[5]._1 = 1;
	pIndices[4]._2 = 1;	pIndices[5]._2 = 0;

	// y-
	pIndices[6]._0 = 3;	pIndices[7]._0 = 3;
	pIndices[6]._1 = 2;	pIndices[7]._1 = 6;
	pIndices[6]._2 = 6;	pIndices[7]._2 = 7;

	// z+
	pIndices[8]._0 = 7;	pIndices[9]._0 = 7;
	pIndices[8]._1 = 6;	pIndices[9]._1 = 5;
	pIndices[8]._2 = 5;	pIndices[9]._2 = 4;

	// z-
	pIndices[10]._0 = 0;	 pIndices[11]._0 = 0;
	pIndices[10]._1 = 1;	 pIndices[11]._1 = 2;
	pIndices[10]._2 = 2;	 pIndices[11]._2 = 3;
